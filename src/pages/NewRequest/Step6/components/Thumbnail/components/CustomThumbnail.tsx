            ...
            <div className={styles.box_content}>
                ...
                <div className={styles.box_content_info}>
                    ...
                    <div className={styles.box_content_info_text}>
                        Your thumbnail is your video's first impression, and you want to make a good one. A custom thumbnail can
                        include graphic elements, text, and/or branding that entices viewers to click. Price includes design and delivery of custom thumbnail.
                    </div>
                </div>
