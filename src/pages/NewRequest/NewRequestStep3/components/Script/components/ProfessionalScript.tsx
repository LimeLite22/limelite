...
const ProffessionalScript = ({ isExpanded, setIsExpanded, isError }: IProps) => {
        ...
        `}
            ...
            <div className={styles.box_inputsContainer}>
                ...
                `}
                        ...
                        type="number"
                    />
                    {((isError.phone && !phoneRegex.test(String(phone))) || isError.email) && (
                        <div
                            className={styles.box_addressContainer_input_errorText}
                        >
                            {!phoneRegex.test(String(phone)) && phone !== '' && phone !== 0 && 'Invalid phone number'}
                            {!phoneRegex.test(String(phone)) && (phone === '' || phone === 0) &&  'Please complete number'}
                        </div>
                    )}
                </div>
                <div className={styles.box_addressContainer}>
            ...
            `}
                    ...
                    {(isError.email && !emailRegex.test(String(email))) && (
                        <div
                            className={styles.box_addressContainer_input_errorText}
                        >
                            {!emailRegex.test(String(email)) && email === '' && 'Please complete email'}
                            {!emailRegex.test(String(email)) && email !== '' && 'Invalid email address'}
