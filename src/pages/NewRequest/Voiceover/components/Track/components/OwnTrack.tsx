...
const OwnTrack = ({ isExpanded, setIsExpanded, isError }: IProps) => {
  ...
  return (
    ...
    ${isExpanded ? styles.box_expanded : ""}`}
      onClick={() => {
        handleUpdateField(
          "voiceTrackSettings.trackAuthor",
          TRACK_AUTHOR_CLIENT,
        );
        setIsExpanded(true);
      }}
    >
      <div className={styles.box_header}>
        <img
          ...
          alt="CheckBox"
        />
        <span className={styles.box_title}>We'll provide the voice track</span>
      ...
      <div className={styles.box_container}>
        ...
        <div>
          ...
          <div onClick={handleDivClick} className={styles.box_audioFileButton}>
            ...
            />
            <span style={{ color: isError.track ? "var(--red-dark)" : "" }}>
