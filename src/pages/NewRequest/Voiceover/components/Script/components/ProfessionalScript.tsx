      ...
      <div className={styles.box_container}>
        <div className={styles.box_content}>
          ...
          <div className={styles.box_content_info}>
            ...
            <div className={styles.box_content_info_text}>
              ...
              LimeLite Scriptwriters specialize in writing brief,
              conversational, and persuasive scripts that inform and engage.
              Price includes up to three interviews with SME’s, scriptwriting,
        ...
        <div className={styles.box_addressContainer}>
          ...
          <input
            ...
            onChange={(e) => {
              handleUpdateField(
                "voiceTrackSettings.scriptAuthorProfSettings.subject",
                e.target.value,
              );
            }}
        ...
        <div className={styles.box_inputsContainer}>
          <div className={styles.box_addressContainer}>
            ...
            <input
              ...
              onChange={(e) => {
                handleUpdateField(
                  "voiceTrackSettings.scriptAuthorProfSettings.phone",
                  e.target.value,
                );
              }}
          ...
          <div className={styles.box_addressContainer}>
            ...
            `}
              ...
              onChange={(e) => {
                handleUpdateField(
                  "voiceTrackSettings.scriptAuthorProfSettings.email",
                  e.target.value,
                );
              }}
