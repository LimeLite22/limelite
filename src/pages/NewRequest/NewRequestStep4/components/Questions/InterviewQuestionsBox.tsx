...
import { DEFAULT, QUESTIONS_AUTHOR_CLIENT, QUESTIONS_AUTHOR_PROFESSIONAL } from "interfaces/interfaces";
...
const InterviewQuestionsBox = () => {
  ...
  const ownText = selectedRequest?.interviewSettings.questionsAuthorOwnSettings?.text;
  const proffessionalText = selectedRequest?.interviewSettings.questionsAuthorProfSettings?.text;
  ...
  useEffect(() => {
    ...
    if (selection === QUESTIONS_AUTHOR_PROFESSIONAL) setIsProffessionalExpanded(true);
    setIsError({
      subject: false,
      phone: false,
      email: false,
  ...
  return (
    ...
    >
      ...
      <LearnMorePopUp />
      <OwnQuestions isError={{ text: isError.ownScript }} isExpanded={isOwnExpanded} setIsExpanded={setIsOwnExpanded} />
