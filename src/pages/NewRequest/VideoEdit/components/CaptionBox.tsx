    ...
    <div className={styles.captions}>
      <div>
        ...
        <div className={styles.box_title2}>
          Do you need video caption files? (Included in subscription)
        </div>
      </div>
      <div
        className={styles.switcher}
        style={{ background: captions ? "var(--green-dark)" : "" }}
        onClick={handleClick}
      >
        <div
          className={`${styles.switcher_circle} ${captions ? styles.switcher_circle_active : ""}`}
        ></div>
      </div>
    </div>
  );
