                ...
                <div className={styles.textarea_estimate}>
                    <div >
                        ...
                        <span style={{ color: minutes > 2 ? "var(--red-dark)" : '' }}>
                            <span className={styles.textarea_estimate_number}> {minutes} </span> Min and
                            <span className={styles.textarea_estimate_number}> {seconds} </span> Sec
                        </span>
                    </div>
                    <div className={styles.textarea_estimate_words}><span style={{ color: minutes > 2 ? "var(--red-dark)" : '' }}>{wordCount}</span>/450 words</div>
                </div>
                {(isError.text) && (
                    <div
